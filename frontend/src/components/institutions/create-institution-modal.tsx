...
interface CreateInstitutionModalProps {
  onClose: () => void;
  onCreated: (institution: InstitutionResponse) => void;
}
...
export function CreateInstitutionModal({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const institution = await createInstitution({ name, acronym });
