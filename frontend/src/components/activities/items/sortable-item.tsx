...
export function SortableItem({
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className="group flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-3 rounded-xl border border-surface-border bg-surface p-2 sm:p-3 transition-all duration-300 hover:-translate-y-1 hover:border-secondary/50 hover:bg-surface-light hover:shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
        >
            <button
                {...attributes}
                {...listeners}
